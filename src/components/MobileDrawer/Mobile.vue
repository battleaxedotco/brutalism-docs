...
.mobile-drawer {
  ...
  transition: right 750ms var(--quint) 20ms;
...
.drawer-anchor-item:first-child, .drawer-route-item:first-child {
  margin-top: 10px;
}
.drawer-anchor-item:last-child, .drawer-route-item:last-child {
  margin-bottom: 10px;
}

.drawer-anchor-item, .drawer-route-item {
